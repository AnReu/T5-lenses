...
class T5Stack(T5PreTrainedModel):
    ...
    def forward(
        ...
        all_activations = () if self.is_decoder else None
        position_bias = None
        encoder_decoder_position_bias = None

        hidden_states = self.dropout(inputs_embeds)

        if layer_decoder_lens is None:
            layer_decoder_lens = len(self.block) - 1
        
        for i, (layer_module, past_key_value) in enumerate(zip(self.block, past_key_values)):
            if (not self.is_decoder) and (i > layer_decoder_lens):
                break
...
class T5Model(T5PreTrainedModel):
    ...
    def forward(
        ...
        layer_decoder_lens: Optional[int] = None,
        ...
        if encoder_outputs is None:
            encoder_outputs = self.encoder(
                ...
                layer_decoder_lens=layer_decoder_lens,
            )
    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        return {
            ...
            "cross_attn_head_mask": cross_attn_head_mask,
            "use_cache": use_cache,
            "layer_decoder_lens": kwargs.get("layer_decoder_lens", None),
        }
